...
(define (first-conjunct exp) (car exp))
  ...
  '(
    ...
    (rule (lives-near ?person-1 ?person-2)
	  (and (address ?person-1 (?town . ?rest-1))
	       ...
	       (lisp-value string<?
			   (write-to-string '?person-1)
			   (write-to-string '?person-2))))
